...
@bot.tree.command(name='ticket-panel', description='Displays the ticket panel embed')
...
async def about(interaction: discord.Interaction):
    ...
    ping = round(bot.latency * 1000)  # Latency in milliseconds
    ...
    embed.add_field(name="Developer Tag", value="@codexis_ (368866869660221440)", inline=True)
...
async def statistics(interaction: discord.Interaction):
    ...
    developer_tag = "Developer: YourName"  # Replace with actual developer name
